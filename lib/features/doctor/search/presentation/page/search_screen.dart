...
class DoctorSearchScreen extends StatefulWidget {
  const DoctorSearchScreen({super.key, this.keyword});
  final String? keyword;
  @override
  State<DoctorSearchScreen> createState() => _SearchScreenState();
}

class _SearchScreenState extends State<DoctorSearchScreen> {
